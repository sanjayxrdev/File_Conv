...
export const QuickCommandPalette: React.FC = () => {
  ...
  const commands: CommandItem[] = [
    ...
    {
      id: 'pdf-compress',
      title: 'PDF Compressor (Balanced, Extreme & Lossless)',
      category: 'PDF Studio',
      path: '/pdf/compress',
      icon: <FileText className="w-4 h-4 text-emerald-500" weight="bold" />,
    },
    {
      id: 'pdf-alternate-mix',
      title: 'PDF Alternate & Mix (Duplex Scanner Weaver)',
      category: 'PDF Studio',
      path: '/pdf/alternate-mix',
      icon: <GitMerge className="w-4 h-4 text-blue-500" weight="bold" />,
    },
    {
      id: 'pdf-watermark',
      title: 'PDF Watermark Studio (Text & Logo)',
      category: 'PDF Studio',
      path: '/pdf/watermark',
      icon: <FileText className="w-4 h-4 text-amber-500" weight="bold" />,
    },
    {
      id: 'pdf-bates',
      title: 'PDF Bates Numbering (Legal Stamping)',
      category: 'PDF Studio',
      path: '/pdf/bates-numbering',
      icon: <FileText className="w-4 h-4 text-indigo-500" weight="bold" />,
    },
    {
      id: 'pdf-financial',
      title: 'Bank Statement & Table Extractor to Excel',
      category: 'AI Document Intelligence',
      path: '/pdf/financial-extractor',
      icon: <FileText className="w-4 h-4 text-emerald-600" weight="bold" />,
    },
    {
      id: 'pdf-flatten-grayscale',
      title: 'PDF Flatten Forms & Grayscale Optimizer',
      category: 'PDF Studio',
      path: '/pdf/flatten-grayscale',
      icon: <FileText className="w-4 h-4 text-gray-500" weight="bold" />,
    },
    {
      id: 'pdf-crop',
      title: 'PDF Crop Margins & Bleed Trimmer',
      category: 'PDF Studio',
      path: '/pdf/crop',
      icon: <FileText className="w-4 h-4 text-teal-500" weight="bold" />,
    },
    {
      id: 'merge',

...
export const CONVERTER_CATEGORIES: Record<string, ConverterCategoryConfig> = {
  ...
  'ocr-converter': {
    ...
    categoryName: 'OCR & AI',
    description: 'AI-powered OCR and layout parsing powered by Docling. Extract structured Markdown, JSON AST, Text, HTML, or DOCX from scanned PDFs, images, and documents.',
    icon: <Scan className="w-7 h-7" weight="bold" />,
    accentBg: 'bg-purple-100',
    accentText: 'text-purple-800',
    acceptedFormatsText: 'PDF, PNG, JPG, JPEG, WEBP, DOCX, PPTX, XLSX',
    defaultTargetFormat: 'md',
  },
